...
public class QuakeSortWithTwoArrayLists {
    ...
    public void testSort() {
        ...
        String source = "/Users/Gz/Desktop/eclipse/duke4/earthquakeDataSampleSix1.atom.txt";
    ...
    public static void main(String args[]){
    	QuakeSortWithTwoArrayLists qsw = new QuakeSortWithTwoArrayLists();
    	EarthQuakeParser parser = new EarthQuakeParser(); 
        String source = "/Users/Gz/Desktop/eclipse/duke4/earthquakeDataSampleSix1.atom.txt";
        ArrayList<QuakeEntry> list  = parser.read(source); 
        ArrayList<QuakeEntry> ans = qsw.sortByMagnitude(list);
