...
public class CaesarBreaker {
    ...
    public String decryptFileTwoKeys() {
        ...
        String str = decryptTwoKeys(fr.asString());
        return str;
    }
    public static void main(String args[]){
    	CaesarBreaker cb = new CaesarBreaker();
//    	String str = cb.decryptTwoKeys("Aal uttx hm aal Qtct Fhljha pl Wbdl. Pvxvxlx!");
//    	String str = cb.decrypt("Hfs cpwewloj loks cd Hoto kyg Cyy.",14,24);
//    	System.out.println(str);
    	String str = cb.decryptFileTwoKeys();
    	System.out.println(str);
    }
